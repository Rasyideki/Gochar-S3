  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../- Javier/misi.php">
    ...
    <main id="main" class="main">
      ...
      <form method="post">
         ...
         <?php $ambil = $koneksi->query("SELECT * FROM misi"); ?>
         <?php while($per_data = $ambil->fetch_assoc()){?>
            <div class="col-xl-6 mx-auto">

              <div class="card border-bottom border-primary border-3">
                <div class="card-body profile-card pt-4 d-flex flex-column">
                  <h3 name="judul"><?php echo $per_data['judul']?></h3>
                  <hr>
                  <p name="deskripsi"><?php echo $per_data['deskripsi']?></p>
                  <div class="mt-2">
                    <img src="https://cdn-icons-png.flaticon.com/512/5219/5219370.png" style="width: 20px; height: 20px"/></img>
                    <p style="float: left;" name="login"><?php echo $per_data['poin']?></p>
                  </div>
                  <br>
                  <button type="button" name="klaim" class="btn btn-outline-primary btn btn-sm">Klaim</button>
                </div>
              </div>
            </div>
          <?php }?>
